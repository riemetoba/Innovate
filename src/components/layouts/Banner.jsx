...
import ColorFunction from "../pages/ColorFunction";
  ...
  return (
    <div className="bg-[url('/src/assets/bannerBg.jpg')] bg-no-repeat bg-cover bg-center pb-[100px] pt-[90px]">
      <Container>
        <ColorFunction
          className={
            "pt-[150px] font-open font-extrabold text-[72px] w-[686px]"
          }
        ...
        <Heading
          className={
            "pt-6 font-paprika text-[20px] text-[#6C7D93] w-[571px] leading-9"
          }
          text={
        ...
        />
        <Button
          className={"capitalize font-open text-[20px] font-bold my-6"}
          btnText={"get free quoto"}
        />
      </Container>
    </div>
  );
